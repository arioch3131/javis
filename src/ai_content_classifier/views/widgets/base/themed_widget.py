...
class ThemedWidget(QWidget, ThemeMixin):
    ...
    - Gestion d'state commune (enabled, visible, etc.)
    ...
    state_changed = pyqtSignal(str)  # State du widget
    ...
    def get_main_layout(self) -> Optional[QVBoxLayout]:
        """Return ou create le layout principal."""
    ...
    def create_horizontal_layout(
        ...
        """Create un layout horizontal avec settings standards."""
        layout = QHBoxLayout()
    ...
    def create_vertical_layout(
        ...
        """Create un layout vertical avec settings standards."""
        layout = QVBoxLayout()
        layout.setSpacing(spacing)
        layout.setContentsMargins(*margins)
        return layout
    ...
    def set_success(self, success: bool):
        """Marque le widget comme en success."""
