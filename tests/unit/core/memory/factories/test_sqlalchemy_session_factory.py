...
from ai_content_classifier.core.memory.factories.sqlalchemy_session_factory import SQLAlchemySessionFactory
...
class TestSQLAlchemySessionFactory:
    ...
    def test_create_with_kwargs(self):
        ...
        assert result == mock_session
        self.database_service.Session.assert_called_once_with(some_param="value", another_param=123)
    ...
    def test_create_database_service_exception(self):
        ...
        self.database_service.Session.side_effect = Exception("Database connection failed")
