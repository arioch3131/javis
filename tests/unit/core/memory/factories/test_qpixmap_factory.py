...
class TestQPixmapFactory(unittest.TestCase):
    ...
    def test_init_custom_values(self):
        ...
        factory = QPixmapFactory(default_format=QImage.Format.Format_RGB32,
                                 reset_color=custom_color)
    ...
    def test_estimate_size(self):
        ...
        """
        pixmap_rgb32 = self.factory.create(10, 10, pixel_format=QImage.Format.Format_RGB32)
        ...
        self.assertLessEqual(size_rgb32, 1000)    # At most ~10 bytes per pixel with overhead

        pixmap_rgb888 = self.factory.create(10, 10, pixel_format=QImage.Format.Format_RGB888)
        ...
        pixmap_grayscale = self.factory.create(10, 10, pixel_format=QImage.Format.Format_Grayscale8)
