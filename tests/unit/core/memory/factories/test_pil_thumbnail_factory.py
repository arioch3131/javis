...
from ai_content_classifier.core.memory.factories.pil_thumbnail_factory import (
    PilThumbnailFactory,
)
...
class TestPilThumbnailFactory:
    ...
    def test_create_success_with_handler(self):
        ...
        self.format_handlers[".jpg"].assert_called_once_with(
            image_path, size, quality_factor
        )
    ...
    def test_create_handler_returns_none_fallback_to_placeholder(self):
        ...
        self.format_handlers[".png"].assert_called_once_with(
            image_path, size, quality_factor
        )
