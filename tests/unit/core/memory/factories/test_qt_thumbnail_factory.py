...
class TestQtThumbnailFactory:
    ...
    def setup_method(self):
        ...
        try:
            from ai_content_classifier.core.memory.factories.qt_thumbnail_factory import (
                QtThumbnailFactory,
            )
    ...
    def test_create_with_handler(self):
        ...
        self.format_handlers[".jpg"].assert_called_once_with(
            "/test/image.jpg", (100, 100), 0.8
        )
    ...
    def test_create_with_pil_generator(self):
        ...
        assert result == mock_qpixmap
        self.pil_generator.generate.assert_called_once_with(
            "/test/image.bmp", (100, 100), 0.8
        )
    ...
    def test_validate_valid_qpixmap(self):
        ...
        with patch(
            "ai_content_classifier.core.memory.factories.qt_thumbnail_factory.isinstance",
            return_value=True,
        ):
