...
from ai_content_classifier.core.memory.factories.query_result_factory import QueryResultFactory
...
class TestQueryResultFactory:
    ...
    def test_realistic_query_result_simulation(self):
        ...
        simulated_results = [
            {"user_id": 1, "username": "alice", "email": "alice@example.com", "created_at": "2023-01-01"},
            {"user_id": 2, "username": "bob", "email": "bob@example.com", "created_at": "2023-01-02"},
            {"user_id": 3, "username": "charlie", "email": "charlie@example.com", "created_at": "2023-01-03"},
        ]
