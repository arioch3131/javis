...
class TestContentReader:
    ...
    def reader(self, mock_database_service):
        ...
        with patch(
            "ai_content_classifier.services.database.content_reader.ContentItem",
            ContentItem,
        ):
    ...
    def test_find_items_with_content_filter(
        self, reader, mock_db_session, mock_content_filter, mock_content_item
    ):
    ...
    def test_find_items_with_custom_filter(
    ...
    def test_find_items_with_both_filters(
        self, reader, mock_db_session, mock_content_filter, mock_content_item
    ):
        ...
        items = reader.find_items(
            content_filter=mock_content_filter, custom_filter=custom_filter
        )
    ...
    def test_find_items_with_pagination(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_find_items_offset_without_limit(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_find_items_with_eager_load(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_find_items_complex_combination(
        self, reader, mock_db_session, mock_content_filter, mock_content_item
    ):
    ...
    def test_find_items_sqlalchemy_error(self, reader, mock_db_session):
        ...
        mock_db_session.query.return_value.all.side_effect = SQLAlchemyError(
            "Database error"
        )
    ...
    def test_find_items_with_external_session(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_find_items_invalid_sort_column(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_get_items_pending_metadata_basic(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_get_items_pending_metadata_with_content_type(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_get_items_pending_metadata_with_limit(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_get_items_pending_metadata_with_eager_load(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_get_items_pending_metadata_combination(
        self, reader, mock_db_session, mock_content_item
    ):
        ...
        items = reader.get_items_pending_metadata(
            content_type="image", limit=10, eager_load=True
        )
    ...
    def test_get_items_pending_metadata_with_external_session(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_get_statistics_sqlalchemy_error(self, reader, mock_db_session):
        ...
        # Reset any previous side_effects
        mock_db_session.query.side_effect = None
        mock_db_session.query.return_value.scalar.side_effect = SQLAlchemyError(
            "Stats error"
        )
    ...
    def test_get_content_by_path_with_external_session(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_get_uncategorized_items_basic(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_get_uncategorized_items_with_content_type(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_get_uncategorized_items_with_external_session(
        self, reader, mock_db_session, mock_content_item
    ):
    ...
    def test_private_methods_integration(
        self, reader, mock_db_session, mock_content_item
    ):
