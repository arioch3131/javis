import pytest
from ai_content_classifier.services.theme.theme_service import ThemeService, ThemePalette
...
class TestThemeService:
    ...
    def test_export_import_theme_roundtrip_preserves_contract(self, theme_service, tmp_path):
