...
from ai_content_classifier.services.llm.category_analyzer import (
    CategoryAnalyzer, CategoryExtractionConfig, CategoryExtractionResult
)
...
class TestCategoryAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Catégories de test
        self.test_categories = ["sports", "technology", "health", "education", "entertainment"]
        
        # Créer l'analyzer et mock le logger après création
        self.analyzer = CategoryAnalyzer(config=self.test_config, log_level=logging.DEBUG)
    ...
    def test_extract_category_with_confidence_explicit_statement(self):
        ...
        result = self.analyzer.extract_category_with_confidence(response_text, self.test_categories)
    ...
    def test_extract_category_with_confidence_validation_failed(self):
        ...
        result = self.analyzer.extract_category_with_confidence("", self.test_categories)
    ...
    def test_match_extracted_to_categories_with_multi_word(self):
        ...
        result = self.analyzer._match_extracted_to_categories(
            "this is about artificial intelligence research", normalized_categories, original_categories
        )
    ...
    def test_find_negative_mentions(self):
        ...
        negative_mentions = self.analyzer._find_negative_mentions(text, patterns, normalized_categories)
    ...
    def test_is_in_negative_context(self):
        ...
        self.assertFalse(self.analyzer._is_in_negative_context((15, 18), negative_spans))
    ...
    def test_get_extraction_statistics_valid_input(self):
        ...
        stats = self.analyzer.get_extraction_statistics(response_text, self.test_categories)
    ...
    def test_extract_category_with_confidence_exception_in_strategy(self):
        ...
        with patch.object(self.analyzer, '_extract_by_explicit_statement', side_effect=Exception("Test error")):
    ...
    def test_extract_category_with_confidence_all_strategies_fail(self):
        ...
        with patch.object(self.analyzer, '_extract_by_explicit_statement', return_value=None), \
             patch.object(self.analyzer, '_extract_by_emphasis', return_value=None), \
             patch.object(self.analyzer, '_extract_by_positive_context', return_value=None), \
             patch.object(self.analyzer, '_extract_by_frequency_analysis', return_value=None):
    ...
    def test_empty_pattern_lists(self):
        ...
        response_text = "Category: sports"
        result = analyzer.extract_category_with_confidence(response_text, self.test_categories)
