...
with patch('ai_content_classifier.core.logger.LoggableMixin', LoggableMixin):
    from ai_content_classifier.services.thumbnail.generators.svg_generator import SvgGenerator
...
class TestSvgGeneratorQtAvailability:
        ...
        try:
            ...
            with patch.dict('sys.modules', {
                ...
                try:
                    ...
                    svg_module.QT_AVAILABLE = False  # This is the line we want to cover!
    ...
    def test_module_reload_with_import_error(self):
        ...
        module_name = 'ai_content_classifier.services.thumbnail.generators.svg_generator'
...
class TestSvgGenerator:
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.QT_AVAILABLE', False)
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.QT_AVAILABLE', True)
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.QSvgRenderer')
    ...
    def test_generate_success_landscape(self, mock_getsize, mock_painter_class, mock_pixmap_class, mock_renderer_class, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.QPainter')
    @patch('os.path.getsize')
    def test_generate_success_portrait(self, mock_getsize, mock_painter_class, mock_pixmap_class, mock_renderer_class, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.QPainter')
    @patch('os.path.getsize')
    def test_generate_large_file_no_antialiasing(self, mock_getsize, mock_painter_class, mock_pixmap_class, mock_renderer_class, generator):
        ...
        mock_painter.setRenderHint.assert_any_call(mock_painter_class.RenderHint.Antialiasing, False)
        mock_painter.setRenderHint.assert_any_call(mock_painter_class.RenderHint.SmoothPixmapTransform, False)
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.QPainter')
    @patch('os.path.getsize')
    def test_generate_invalid_viewbox(self, mock_getsize, mock_painter_class, mock_pixmap_class, mock_renderer_class, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.QPainter')
    @patch('os.path.getsize')
    def test_generate_load_fails_with_fallback(self, mock_getsize, mock_painter_class, mock_pixmap_class, mock_renderer_class, generator):
        """Test SVG generation when initial load fails but fallback succeeds"""
        # Mock renderer
        mock_renderer = Mock()
        mock_renderer.load.side_effect = [False, True]  # First call fails, second succeeds
        mock_view_box = Mock()
        mock_view_box.width.return_value = 100
        mock_view_box.height.return_value = 100
        mock_renderer.viewBoxF.return_value = mock_view_box
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.QT_AVAILABLE', True)
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.QSvgRenderer')
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.PlaceholderGenerator')
    def test_generate_exception_returns_placeholder(self, mock_placeholder_class, mock_renderer_class, generator):
        ...
        mock_placeholder_generator.generate.assert_called_once_with("test.svg", (100, 100), 1.0)
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.QPainter')
    @patch('os.path.getsize')
    def test_generate_with_quality_factor(self, mock_getsize, mock_painter_class, mock_pixmap_class, mock_renderer_class, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.svg_generator.QPainter')
    @patch('os.path.getsize')
    def test_generate_medium_file_with_antialiasing(self, mock_getsize, mock_painter_class, mock_pixmap_class, mock_renderer_class, generator):
        ...
        mock_painter.setRenderHint.assert_any_call(mock_painter_class.RenderHint.Antialiasing, True)
        mock_painter.setRenderHint.assert_any_call(mock_painter_class.RenderHint.SmoothPixmapTransform, True)