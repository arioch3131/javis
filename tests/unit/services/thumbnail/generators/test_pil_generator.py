...
with patch('ai_content_classifier.core.logger.LoggableMixin', LoggableMixin):
    from ai_content_classifier.services.thumbnail.generators.pil_generator import PilGenerator
...
class TestPilGenerator:
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.Image.open')
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.ImageOps.exif_transpose')
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.Image.open')
    @patch('builtins.open')
    def test_generate_all_open_methods_fail(self, mock_builtin_open, mock_image_open, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.Image.open')
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.ImageOps.exif_transpose')
    def test_generate_exif_transpose_success(self, mock_transpose, mock_open, generator, mock_image):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.Image.open')
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.ImageOps.exif_transpose')
    def test_generate_with_quality_factor(self, mock_transpose, mock_open, generator, mock_image):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.Image.open')
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.ImageOps.exif_transpose')
    def test_generate_with_very_small_quality_factor(self, mock_transpose, mock_open, generator, mock_image):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.Image.open')
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.ImageOps.exif_transpose')
    def test_generate_thumbnail_lanczos_fallback_to_bicubic(self, mock_transpose, mock_open, generator, mock_image):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.Image.open')
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.ImageOps.exif_transpose')
    def test_generate_thumbnail_all_resampling_methods_fail_use_nearest(self, mock_transpose, mock_open, generator, mock_image):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.ImageOps.exif_transpose')
    @patch('builtins.open', new_callable=mock_open, read_data=b'image_data')
    def test_generate_unicode_encode_error_fallback(self, mock_builtin_open, mock_transpose, mock_image_open, generator, mock_image):
        """Test fallback when UnicodeEncodeError occurs"""
        mock_image_open.side_effect = [UnicodeEncodeError("utf-8", "", 0, 1, "test"), mock_image]
        mock_transpose.return_value = mock_image
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.pil_generator.ImageOps.exif_transpose')
    @patch('builtins.open', new_callable=mock_open, read_data=b'image_data')
    def test_generate_unicode_decode_error_fallback(self, mock_builtin_open, mock_transpose, mock_image_open, generator, mock_image):
        """Test fallback when UnicodeDecodeError occurs"""
        mock_image_open.side_effect = [UnicodeDecodeError("utf-8", b"", 0, 1, "test"), mock_image]
        mock_transpose.return_value = mock_image
