...
class TestSimplePlaceholderGenerator:
    ...
    def generator(self):
        ...
        from ai_content_classifier.services.thumbnail.generators.placeholder_generators import (
    ...
    @patch(
        "ai_content_classifier.services.thumbnail.generators.placeholder_generators.Image.new"
    )
...
""",
    ...
    def test_direct_importerror_simulation(self):
        ...
        try:
            ...
            with patch.dict(
                "sys.modules",
                {"PyQt6": None, "PyQt6.QtCore": None, "PyQt6.QtGui": None},
            ):
...
class TestPlaceholderGeneratorWithQt:
    ...
    def mock_qt_classes(self):
        ...
        with (
            patch(
                "ai_content_classifier.services.thumbnail.generators.placeholder_generators.QPixmap",
                mock_qpixmap,
            ),
            patch(
                "ai_content_classifier.services.thumbnail.generators.placeholder_generators.QPainter",
                mock_qpainter,
            ),
            patch(
                "ai_content_classifier.services.thumbnail.generators.placeholder_generators.Qt",
                mock_qt,
            ),
            patch(
                "ai_content_classifier.services.thumbnail.generators.placeholder_generators.QT_AVAILABLE",
                True,
            ),
        ):
    ...
    def test_generate_with_quality_factor(self, generator_with_qt, mock_qt_classes):
        ...
        assert result == mock_pixmap
        mock_qpixmap.assert_called_once_with(
            100, 100
        )  # Size not affected by quality_factor
