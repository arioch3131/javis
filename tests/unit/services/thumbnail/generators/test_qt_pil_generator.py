...
with patch('ai_content_classifier.core.logger.LoggableMixin', LoggableMixin):
    from ai_content_classifier.services.thumbnail.generators.qt_pil_generator import QtPilGenerator
...
class TestQtPilGeneratorAdditionalCoverage:
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QT_AVAILABLE', True)
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.Image.open')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.ImageOps.exif_transpose')
    def test_progressive_jpeg_conversion_error(self, mock_transpose, mock_open, generator):
        ...
        with patch('io.BytesIO'):
            with patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap'):
                with patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage'):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.Image.open')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.ImageOps.exif_transpose')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_quality_factor_edge_cases(self, mock_qimage_class, mock_qpixmap_class, mock_transpose, mock_open, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_thumbnail_lanczos_fallback_chain(self, mock_qimage_class, mock_qpixmap_class, mock_transpose, mock_open, generator):
    ...
    def test_rgba_mode_final_conversion(self, mock_transpose, mock_open, generator):
        ...
        with patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage') as mock_qimage_class:
            with patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap') as mock_qpixmap_class:
                mock_qimage = Mock()
                mock_qimage.isNull.return_value = False
                mock_qimage_class.return_value = mock_qimage
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.Image.open')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.ImageOps.exif_transpose')
    def test_unicode_decode_error_fallback(self, mock_transpose, mock_image_open, generator):
        ...
        unicode_error = UnicodeDecodeError("utf-8", b"\xff\xfe", 0, 1, "invalid start byte")
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.Image.open')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.ImageOps.exif_transpose')
    def test_unicode_encode_error_fallback(self, mock_transpose, mock_image_open, generator):
        ...
        unicode_error = UnicodeEncodeError("ascii", "\u2603", 0, 1, "ordinal not in range(128)")
...
class TestQtPilGenerator:
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QT_AVAILABLE', False)
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_generate_success(self, mock_qimage_class, mock_qpixmap_class, mock_transpose, mock_open, generator, mock_image):
    ...
    def test_generate_image_open_error_with_fallback(self, mock_builtin_open, mock_transpose, mock_image_open, generator, mock_image):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.Image.open')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.ImageOps.exif_transpose')
    def test_generate_exif_transpose_error(self, mock_transpose, mock_open, generator, mock_image):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_generate_p_mode_with_transparency(self, mock_qimage_class, mock_qpixmap_class, mock_transpose, mock_open, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_generate_p_mode_without_transparency(self, mock_qimage_class, mock_qpixmap_class, mock_transpose, mock_open, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_generate_la_mode(self, mock_qimage_class, mock_qpixmap_class, mock_transpose, mock_open, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_generate_l_mode(self, mock_qimage_class, mock_qpixmap_class, mock_transpose, mock_open, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_generate_cmyk_mode(self, mock_qimage_class, mock_qpixmap_class, mock_transpose, mock_open, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_generate_unknown_mode(self, mock_qimage_class, mock_qpixmap_class, mock_transpose, mock_open, generator):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_generate_with_quality_factor(self, mock_qimage_class, mock_qpixmap_class, mock_transpose, mock_open, generator, mock_image):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_generate_qimage_is_null(self, mock_qimage_class, mock_qpixmap_class, mock_open, generator, mock_image):
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_generate_qpixmap_is_null(self, mock_qimage_class, mock_qpixmap_class, mock_open, generator, mock_image):
    ...
    def test_generate_qt_conversion_error(self, mock_open, generator, mock_image):
        ...
        with patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage', side_effect=Exception("Qt error")):
            result = generator.generate("test.jpg", (100, 100))
    ...
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QPixmap')
    @patch('ai_content_classifier.services.thumbnail.generators.qt_pil_generator.QImage')
    def test_generate_final_rgb_conversion(self, mock_qimage_class, mock_qpixmap_class, mock_transpose, mock_open, generator):
